...
public class WorldGenMinableNether extends WorldGenerator {
	...
	public WorldGenMinableNether(Block blk, int par3) {
		this.minableBlock = blk;
				...
				for (int i2 = k; i2 <= j1; i2++) {
					...
					for (int j2 = l; j2 <= k1; j2++) {
						...
						if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D
								&& par1World.getBlock(l1, i2, j2) == Blocks.netherrack) {
							par1World.setBlock(l1, i2, j2, this.minableBlock);
						}
					}
				}
			}
